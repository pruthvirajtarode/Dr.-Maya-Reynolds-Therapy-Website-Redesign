      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24">
          ...
          <div className="lg:w-2/3">
            <StaggerContainer delay={0.2} className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
              {therapist.modalities.map((modality, i) => (
                <StaggerItem key={i}>
                  <div className="border-t border-[var(--color-brand-secondary)]/30 pt-8 h-full hover:border-[var(--color-brand-primary)] transition-colors duration-500">
